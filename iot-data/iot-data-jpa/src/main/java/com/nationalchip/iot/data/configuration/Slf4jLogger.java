...
public class Slf4jLogger extends AbstractSessionLog {
    ...
    static {
        ...
        MAP_LEVELS.put(SessionLog.FINER, LogLevel.DEBUG);

        //将EclipseLink.FINE映射为Slf4j.INFO的意义在于，
        //只有当级别小于等于FINE时，EclipseLink才打印sql，
        //如果将FINE映射为DEBUG或更低，那么打印sql的同时
        //也会打印许多无关的信息，而且这样可以在JPA中设置一个二级开关，
        //单独控制是否打印sql
        MAP_LEVELS.put(SessionLog.FINE, LogLevel.INFO);
